...
const creativeBriefsRoutes = require('./routes/creativeBriefs');
...
app.use(
  cors({
    ...
    credentials: true,
    // Exponemos Content-Disposition para que el frontend pueda leer el
    // filename del header al descargar packs (briefs/:id/pack).
...
app.use('/api/experiments/:experimentId/briefs', creativeBriefsRoutes);
